...
/usr/local/opt/android-sdk/build-tools/27.0.1/zipalign -v 4 platforms/android/build/outputs/apk/release/android-release-unsigned.apk ~/Documents/Alloc\ Modulo/RADAR/Dev/Application-Signed-Binaries/radar-armt-app-3.apk

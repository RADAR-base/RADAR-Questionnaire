...
import { ClinicalTasksPage } from './pages/clinical-tasks/clinical-tasks-page.component'
import { EnrolmentPage } from './pages/enrolment/enrolment-page.component'
import { AuthService } from './pages/enrolment/services/auth.service'
import { FinishPage } from './pages/finish/finish-page.component'

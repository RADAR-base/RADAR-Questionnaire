...
export class ScheduleGeneratorService {
  ...
  getProtocolValues(protocol, type, refTimestamp) {
    ...
    // repeatQuestionnaire/repeatQ - The child protocol which specifies the individual task time based on the reference timestamp generated by the repeatProtocol.

    ...
    this.consentPageItems = [
      {
        ...
        detail: [
          ...
          "\n" +
          "In the longer surveys, sent once a week, you will be asked about a wider range of health and non-health related questions. These surveys are designed to take less than 5 minutes to complete. \n" +
          "\n" +
          "We kindly ask you to participate for a period of 3 months.\n"
        ]
      },
      {
        title: "Benefits",
      ...
      },
      {
        ...
        detail: [
          ...
          " \n" +
          "Before you undertake a survey you will be explained in short about its content and you can then decide whether to take part in that particular survey. Should you become distressed, following most surveys, we will include information to signpost you to national support related to the survey you have just undertaken. Additionally, the resource section of the HOME app will have more information about the health and migration services available in the UK. \n" +
          "\n" +
      ...
      },
      {
        ...
        iconMd: "md-log-out",
        detail: [
          "If you have any questions prior to participating in the study or during the course of the study, please feel free to contact the HOME study team at any time by sending us an email at homeappstudy@ucl.ac.uk. \n" +
          "\n" +

  ...
  constructor(
    ...
    this.consentPageItems = [
      ...
      },
      {
        ...
        iconMd: "md-paper",
        detail: [
          "The controller for this project will be University College London (UCL). The UCL Data Protection Officer provides oversight of UCL activities involving the processing of personal data, and can be contacted at data-protection@ucl.ac.uk. This ‘local’ privacy notice sets out the information that applies to this particular study. Further information on how UCL uses participant information can be found in our ‘general’ privacy notice (www.ucl.ac.uk/legal-service).”",
      ...
      },
      {
        ...
        iconMd: "md-log-out",
        detail: [
          "If you have any questions prior to participating in the study or during the course of the study, please feel free to contact the HOME study team at all times by sending us an email at homeappstudy@ucl.ac.uk. We will reply to your message as soon as we can."
        ]
      }
    ]

export class LocKeys {
  ...
  static ENROL_REGISTRATION_STUDY_DESC = new LocKeys('ENROL_REGISTRATION_STUDY_DESC')
  static ENROL_REGISTRATION_ENTER_STUDY_ID = new LocKeys('ENROL_REGISTRATION_ENTER_STUDY_ID')
  static ENROL_REGISTRATION_STUDY_ID = new LocKeys('ENROL_REGISTRATION_STUDY_ID')
  static ENROL_REGISTRATION_ORY_INVALID_CODE = new LocKeys('ENROL_REGISTRATION_ORY_INVALID_CODE')
  ...
  static ENROL_PRIVACY_POLICY_DESC = new LocKeys('ENROL_PRIVACY_POLICY_DESC')
  static BTN_VIEW_POLICY = new LocKeys('BTN_VIEW_POLICY')
  ...
  static FINISH_THANKS_WAIT = new LocKeys('FINISH_THANKS_WAIT')
  ...
  static SETTINGS_HEALTH_CACHE_SIZE = new LocKeys('SETTINGS_HEALTH_CACHE_SIZE')
  ...
  static BTN_RETURN_PORTAL = new LocKeys('BTN_RETURN_PORTAL')
  ...
  static AUDIO_TASK_BUTTON_ALERT_DESC = new LocKeys(
  ...
  // Guided audio task
  static GUIDED_AUDIO_SPEAKING = new LocKeys('GUIDED_AUDIO_SPEAKING')
  static GUIDED_AUDIO_SKIP_TTS = new LocKeys('GUIDED_AUDIO_SKIP_TTS')
  static GUIDED_AUDIO_REPLAY_PROMPT = new LocKeys('GUIDED_AUDIO_REPLAY_PROMPT')
  static GUIDED_AUDIO_RECORDING = new LocKeys('GUIDED_AUDIO_RECORDING')
  static GUIDED_AUDIO_STOP_RECORDING = new LocKeys('GUIDED_AUDIO_STOP_RECORDING')
  static GUIDED_AUDIO_START_RECORDING = new LocKeys('GUIDED_AUDIO_START_RECORDING')
  static GUIDED_AUDIO_RECORDED = new LocKeys('GUIDED_AUDIO_RECORDED')
  static GUIDED_AUDIO_CONFIRM = new LocKeys('GUIDED_AUDIO_CONFIRM')
  static GUIDED_AUDIO_RETRY = new LocKeys('GUIDED_AUDIO_RETRY')
  static GUIDED_AUDIO_UNABLE_TO_SPEAK = new LocKeys('GUIDED_AUDIO_UNABLE_TO_SPEAK')
  static GUIDED_AUDIO_UNABLE_REASON = new LocKeys('GUIDED_AUDIO_UNABLE_REASON')
  static GUIDED_AUDIO_REASON_NO_OUTPUT = new LocKeys('GUIDED_AUDIO_REASON_NO_OUTPUT')
  static GUIDED_AUDIO_REASON_FATIGUE = new LocKeys('GUIDED_AUDIO_REASON_FATIGUE')
  static GUIDED_AUDIO_REASON_TECHNICAL = new LocKeys('GUIDED_AUDIO_REASON_TECHNICAL')
  static GUIDED_AUDIO_REASON_OTHER = new LocKeys('GUIDED_AUDIO_REASON_OTHER')
  static GUIDED_AUDIO_SKIP_CONFIRM = new LocKeys('GUIDED_AUDIO_SKIP_CONFIRM')
  ...
  static EXTERNAL_APP_FAILURE_ON_VALIDATING = new LocKeys(
    'EXTERNAL_APP_FAILURE_ON_VALIDATING'
  )
  static EXTERNAL_APP_FAILURE_ON_LAUNCH_TITLE = new LocKeys(
    'EXTERNAL_APP_FAILURE_ON_LAUNCH_TITLE'
  )
  static EXTERNAL_APP_FAILURE_ON_LAUNCH_DESC = new LocKeys(
  ...
  static BTN_SKIP = new LocKeys('BTN_SKIP')

  static HEALTHKIT_TITLE = new LocKeys('HEALTHKIT_TITLE')
  static HEALTHKIT_PROCESSING_STATUS = new LocKeys('HEALTHKIT_PROCESSING_STATUS')
  static HEALTHKIT_ERROR_PROCESSING = new LocKeys('HEALTHKIT_ERROR_PROCESSING')
  static HEALTHKIT_TAP_TO_START = new LocKeys('HEALTHKIT_TAP_TO_START')
  static HEALTHKIT_READY_DESC = new LocKeys('HEALTHKIT_READY_DESC')
  static HEALTHKIT_NOT_SUPPORTED = new LocKeys('HEALTHKIT_NOT_SUPPORTED')
  static HEALTHKIT_RESUMING = new LocKeys('HEALTHKIT_RESUMING')
  static HEALTHKIT_COMPLETE = new LocKeys('HEALTHKIT_COMPLETE')
  static HEALTHKIT_CHECK_CONNECTION = new LocKeys('HEALTHKIT_CHECK_CONNECTION')
  static HEALTHKIT_TIMEOUT_MSG = new LocKeys('HEALTHKIT_TIMEOUT_MSG')
  static HEALTHKIT_RETURN_HOME = new LocKeys('HEALTHKIT_RETURN_HOME')
  static HEALTHKIT_TIMEOUT_TITLE = new LocKeys('HEALTHKIT_TIMEOUT_TITLE')
  static HEALTHKIT_COLLECTING = new LocKeys('HEALTHKIT_COLLECTING')
  static HEALTHKIT_PROCESSING_UPLOADING = new LocKeys('HEALTHKIT_PROCESSING_UPLOADING')
  static HEALTHKIT_UPLOADING = new LocKeys('HEALTHKIT_UPLOADING')
  static HEALTHKIT_SUCCESS = new LocKeys('HEALTHKIT_SUCCESS')
  static HEALTHKIT_NOT_AVAILABLE = new LocKeys('HEALTHKIT_NOT_AVAILABLE')
  static HEALTHKIT_READY = new LocKeys('HEALTHKIT_READY')
  static HEALTHKIT_SERVER_ERROR = new LocKeys('HEALTHKIT_SERVER_ERROR')
  static HEALTHKIT_NO_CONNECTION = new LocKeys('HEALTHKIT_NO_CONNECTION')
  static HEALTHKIT_CONNECTED = new LocKeys('HEALTHKIT_CONNECTED')

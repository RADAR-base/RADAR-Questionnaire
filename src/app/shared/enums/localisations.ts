export class LocKeys {
  ...
  static LAUNCH_APP_DESC = new LocKeys('LAUNCH_APP_DESC')
  static LAUNCH_APP_FAILURE_ON_VALIDATING = new LocKeys('LAUNCH_APP_FAILURE_ON_VALIDATING')
  static LAUNCH_APP_FAILURE_ON_LAUNCH_TITLE = new LocKeys('LAUNCH_APP_FAILURE_ON_LAUNCH_TITLE')
  static LAUNCH_APP_FAILURE_ON_LAUNCH_DESC = new LocKeys('LAUNCH_APP_FAILURE_ON_LAUNCH_DESC')
  static LAUNCH_APP_BUTTON = new LocKeys('LAUNCH_APP_BUTTON')

export class LocKeys {
    ...
    static SETTINGS_NOTIFICATIONS_SOUND = new LocKeys('SETTINGS_NOTIFICATIONS_SOUND');
    static SETTINGS_NOTIFICATIONS_VIBRATION = new LocKeys('SETTINGS_NOTIFICATIONS_VIBRATION');
    static SETTINGS_NOTIFICATIONS_NIGHTMOD = new LocKeys('SETTINGS_NOTIFICATIONS_NIGHTMOD');
    static SETTINGS_NOTIFICATIONS_NIGHTMOD_DESC = new LocKeys('SETTINGS_NOTIFICATIONS_NIGHTMOD_DESC');
    ...
    static NOTIFICATION_REMINDER_NOW_DESC = new LocKeys('NOTIFICATION_REMINDER_NOW_DESC');
    static NOTIFICATION_REMINDER_FORGOTTEN = new LocKeys('NOTIFICATION_REMINDER_FORGOTTEN');
    static NOTIFICATION_REMINDER_FORGOTTEN_DESC = new LocKeys('NOTIFICATION_REMINDER_FORGOTTEN_DESC');
